...
OV = {
 ...
 "obesity": {
   ...
   "interventions": {
     ...
     "cla": iv("Modula PPARÎ³ y la lipÃ³lisis; efecto modesto en composiciÃ³n corporal.","Modulates PPARÎ³ and lipolysis; modest effect on body composition.","Evidencia inconsistente.","Inconsistent evidence.","[DOSIS_CLINICA_REMOVIDA]/dÃ­a con comida; puede empeorar resistencia a insulina a dosis altas.","[DOSIS_CLINICA_REMOVIDA]y with food; may worsen insulin resistance at high doses.","ClÃ­nico (mixto)"),
   },
 ...
 "hypertension": {
   ...
   "interventions": {
     "garlic": iv("La alicina aumenta el Ã³xido nÃ­trico (vasodilataciÃ³n) e inhibe levemente la ECA.","Allicin raises nitric oxide (vasodilation) and mildly inhibits ACE.","ACE (rs4646994 I/D): el genotipo DD asocia PA mÃ¡s alta.","ACE (rs4646994 I/D): DD genotype associates with higher BP.","[DOSIS_CLINICA_REMOVIDA] de extracto aÃ±ejado/dÃ­a. Baja PAS ~5â€“8 mmHg. Suspender 7â€“10 d antes de cirugÃ­a.","[DOSIS_CLINICA_REMOVIDA] aged extract/day. Lowers SBP ~5â€“8 mmHg. Stop 7â€“10 d before surgery.","Meta-anÃ¡lisis"),
     "magnesium": iv("Antagonista natural del calcio en el mÃºsculo liso vascular â†’ vasodilataciÃ³n.","Natural calcium antagonist in vascular smooth muscle â†’ vasodilation.","DÃ©ficit frecuente empeora la PA.","Common deficiency worsens BP.","[DOSIS_CLINICA_REMOVIDA] (glicinato) por la noche. Baja PAS ~2â€“4 mmHg.","[DOSIS_CLINICA_REMOVIDA] (glycinate) at night. Lowers SBP ~2â€“4 mmHg.","ClÃ­nico"),
     "omega3": iv("EPA/DHA mejoran la funciÃ³n endotelial y bajan la PA levemente.","EPA/DHA improve endothelial function and mildly lower BP.","Beneficio dependiente de la dosis.","Dose-dependent benefit.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/dÃ­a con comida grasa.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/day with a fatty meal.","Meta-anÃ¡lisis"),
     "coq10": iv("Mejora la eficiencia mitocondrial endotelial; efecto hipotensor modesto.","Improves endothelial mitochondrial efficiency; modest hypotensive effect.","Mayor beneficio en dÃ©ficit (uso de estatinas).","Greater benefit in deficiency (statin use).","[DOSIS_CLINICA_REMOVIDA]/dÃ­a (ubiquinol) con comida grasa.","[DOSIS_CLINICA_REMOVIDA] (ubiquinol) with a fatty meal.","ClÃ­nico (mixto)"),
   },
 ...
 "cholesterol": {
   ...
   "interventions": {
     ...
     "bergamot": iv("Polifenoles inhiben HMGCR y ACAT; bajan LDL y triglicÃ©ridos.","Polyphenols inhibit HMGCR and ACAT; lower LDL and triglycerides.","Alternativa/complemento en intolerancia a estatinas.","Alternative/complement in statin intolerance.","[DOSIS_CLINICA_REMOVIDA]/dÃ­a antes de comidas.","[DOSIS_CLINICA_REMOVIDA] before meals.","ClÃ­nico (moderado)"),
     "omega3": iv("Bajan la sÃ­ntesis hepÃ¡tica de VLDL â†’ menos triglicÃ©ridos.","Lower hepatic VLDL synthesis â†’ fewer triglycerides.","Efecto marcado en hipertrigliceridemia.","Marked effect in hypertriglyceridemia.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/dÃ­a con comida grasa. TG -20â€“30%.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/day with a fatty meal. TG -20â€“30%.","Meta-anÃ¡lisis"),
 ...
 "liver": {
   ...
   "interventions": {
     ...
     "milkthistle": iv("Silimarina: antioxidante hepatoprotector, estabiliza la membrana del hepatocito.","Silymarin: antioxidant hepatoprotector, stabilizes the hepatocyte membrane.","Buen perfil de seguridad; evidencia mixta.","Good safety; mixed evidence.","[DOSIS_CLINICA_REMOVIDA] silimarina/dÃ­a con comida.","[DOSIS_CLINICA_REMOVIDA] silymarin/day with food.","ClÃ­nico (moderado)"),
     ...
     "omega3": iv("Bajan triglicÃ©ridos hepÃ¡ticos y activan PPARÎ± (oxidaciÃ³n de Ã¡cidos grasos).","Lower hepatic triglycerides and activate PPARÎ± (fatty-acid oxidation).","Beneficio en el componente de TG.","Benefit on the TG component.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/dÃ­a con comida grasa.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/day with a fatty meal.","ClÃ­nico"),
 ...
 "triglycerides": {
   ...
   "interventions": {
     ...
     "fenugreek": iv("Fibra soluble reduce absorciÃ³n de lÃ­pidos y glucosa.","Soluble fiber reduces lipid and glucose absorption.","Efecto posprandial.","Postprandial effect.","[DOSIS_CLINICA_REMOVIDA] de semilla con comidas.","[DOSIS_CLINICA_REMOVIDA] seed with meals.","ClÃ­nico (moderado)"),
   },
   "expected_outcomes_es": ["TG: omega-3 -20â€“30% a [DOSIS_CLINICA_REMOVIDA]/dÃ­a (efecto mÃ¡s potente).","LDL: levadura roja/berberina aditivos.","Base: reducir azÃºcares simples y alcohol es clave para los TG."],
   "expected_outcomes_en": ["TG: omega-3 -20â€“30% at [DOSIS_CLINICA_REMOVIDA]y (strongest effect).","LDL: red yeast rice/berberine additive.","Foundation: cutting simple sugars and alcohol is key for TG."],
 },
 ...
 "gut microbiota": {
   ...
   "interventions": {
     ...
     "glutamine": iv("Combustible del enterocito: mantiene la integridad de la barrera intestinal.","Enterocyte fuel: maintains gut barrier integrity.","Ãštil en estrÃ©s/daÃ±o de mucosa.","Useful in stress/mucosal damage.","[DOSIS_CLINICA_REMOVIDA]/dÃ­a (hasta [DOSIS_CLINICA_REMOVIDA] en daÃ±o intestinal).","[DOSIS_CLINICA_REMOVIDA]y (up to [DOSIS_CLINICA_REMOVIDA] in gut damage).","ClÃ­nico (mixto)"),
 ...
 "celiac": {
   ...
   "interventions": {
     "vitd": iv("Corrige el dÃ©ficit por malabsorciÃ³n de la mucosa daÃ±ada; salud Ã³sea.","Corrects deficiency from damaged-mucosa malabsorption; bone health.","DÃ©ficit muy frecuente al diagnÃ³stico.","Very common deficiency at diagnosis.","[DOSIS_CLINICA_REMOVIDA]/dÃ­a con control de 25-OH-D; con comida grasa.","[DOSIS_CLINICA_REMOVIDA] with 25-OH-D monitoring; with a fatty meal.","ClÃ­nico"),
     ...
     "b12": iv("MalabsorciÃ³n ileal â†’ dÃ©ficit de B12; reponer.","Ileal malabsorption â†’ B12 deficiency; replete.","Verificar con Ã¡cido metilmalÃ³nico.","Confirm with methylmalonic acid.","500â€“1000 Âµg/dÃ­a (sublingual si malabsorciÃ³n).","[DOSIS_CLINICA_REMOVIDA] (sublingual if malabsorption).","ClÃ­nico"),
 ...
 "folate": {
   ...
   "interventions": {
     "folate": iv("Dador de metilo esencial; en MTHFR C677T conviene el metilfolato (5-MTHF) ya activo.","Essential methyl donor; in MTHFR C677T prefer already-active methylfolate (5-MTHF).","MTHFR (rs1801133 C677T): menor actividad enzimÃ¡tica â†’ preferir metilfolato.","MTHFR (rs1801133 C677T): lower enzyme activity â†’ prefer methylfolate.","400â€“800 Âµg/dÃ­a de metilfolato. No enmascarar dÃ©ficit de B12.","[DOSIS_CLINICA_REMOVIDA] methylfolate. Don't mask B12 deficiency.","ClÃ­nico"),
     "b12": iv("Coopera con el folato en la remetilaciÃ³n de homocisteÃ­na; dÃ©ficit comÃºn en veganos/metformina/IBP.","Works with folate in homocysteine remethylation; deficiency common in vegans/metformin/PPIs.","Verificar antes de suplementar folato solo.","Confirm before supplementing folate alone.","500â€“1000 Âµg/dÃ­a (metilcobalamina).","[DOSIS_CLINICA_REMOVIDA] (methylcobalamin).","ClÃ­nico"),
   },
 ...
 "weight loss": {
   ...
   "interventions": {
     ...
     "5htp": iv("Precursor de serotonina â†’ aumenta la saciedad y reduce el picoteo.","Serotonin precursor â†’ increases satiety and reduces snacking.","Respuesta variable.","Variable response.","[DOSIS_CLINICA_REMOVIDA] antes de comidas o noche.","[DOSIS_CLINICA_REMOVIDA] before meals or at night.","ClÃ­nico (limitado)", contra_es="NO combinar con ISRS/IMAO (riesgo de sÃ­ndrome serotoninÃ©rgico).", contra_en="Do NOT combine with SSRIs/MAOIs (serotonin syndrome risk)."),
   },
 ...
 "gallstones": {
   ...
   "interventions": {
     "artichoke": iv("ColerÃ©tico: la cinarina aumenta el flujo biliar y mejora la digestiÃ³n de grasas.","Choleretic: cynarin increases bile flow and improves fat digestion.","Sin SNP de rutina.","No routine SNP.","[DOSIS_CLINICA_REMOVIDA] antes de las comidas.","[DOSIS_CLINICA_REMOVIDA] before meals.","ClÃ­nico (moderado)", contra_es="CONTRAINDICADO si hay obstrucciÃ³n de la vÃ­a biliar (puede precipitar cÃ³lico).", contra_en="CONTRAINDICATED in bile duct obstruction (may precipitate colic)."),
     "milkthistle": iv("Hepatoprotector; apoya la funciÃ³n hepatobiliar.","Hepatoprotector; supports hepatobiliary function.","Buen perfil de seguridad.","Good safety.","[DOSIS_CLINICA_REMOVIDA] silimarina/dÃ­a.","[DOSIS_CLINICA_REMOVIDA] silymarin/day.","ClÃ­nico (moderado)"),
 ...
 "statins": {
   ...
   "interventions": {
     "coq10": iv("Las estatinas bajan la CoQ10; reponerla mejora la mialgia asociada.","Statins lower CoQ10; repletion improves associated myalgia.","SLCO1B1 (rs4149056): mayor riesgo de miopatÃ­a por estatinas.","SLCO1B1 (rs4149056): higher statin-myopathy risk.","[DOSIS_CLINICA_REMOVIDA]/dÃ­a (ubiquinol) con comida grasa.","[DOSIS_CLINICA_REMOVIDA] (ubiquinol) with a fatty meal.","ClÃ­nico (mixto)", contra_es="", contra_en=""),
     "milkthistle": iv("Hepatoprotector; Ãºtil ante elevaciÃ³n leve de transaminasas.","Hepatoprotector; useful for mild transaminase elevation.","â€”","â€”","[DOSIS_CLINICA_REMOVIDA] silimarina/dÃ­a.","[DOSIS_CLINICA_REMOVIDA] silymarin/day.","ClÃ­nico (moderado)"),
     ...
     "omega3": iv("Reduce triglicÃ©ridos, complemento Ãºtil del tratamiento hipolipemiante.","Reduces triglycerides, useful complement to lipid therapy.","â€”","â€”","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/dÃ­a con comida grasa.","[DOSIS_CLINICA_REMOVIDA] EPA+DHA/day with a fatty meal.","ClÃ­nico"),
   },
 ...
 "silymarin": {
   ...
   "interventions": {
     "milkthistle": iv("La silibinina estabiliza la membrana del hepatocito y es antioxidante.","Silibinin stabilizes the hepatocyte membrane and is antioxidant.","Buen perfil de seguridad.","Good safety.","[DOSIS_CLINICA_REMOVIDA] silimarina/dÃ­a con comida.","[DOSIS_CLINICA_REMOVIDA] silymarin/day with food.","ClÃ­nico (moderado)", contra_es="InhibiciÃ³n leve de CYP2C9/3A4: precauciÃ³n con warfarina y sustratos.", contra_en="Mild CYP2C9/3A4 inhibition: caution with warfarin and substrates."),
     ...
     "ala": iv("Regenera glutatiÃ³n y otros antioxidantes; apoyo hepÃ¡tico.","Regenerates glutathione and other antioxidants; liver support.","â€”","â€”","[DOSIS_CLINICA_REMOVIDA]/dÃ­a en ayunas.","[DOSIS_CLINICA_REMOVIDA] fasting.","ClÃ­nico"),
     "artichoke": iv("ColerÃ©tico y digestivo; complementa el soporte hepatobiliar.","Choleretic and digestive; complements hepatobiliary support.","â€”","â€”","[DOSIS_CLINICA_REMOVIDA] antes de comidas.","[DOSIS_CLINICA_REMOVIDA] before meals.","ClÃ­nico (moderado)", contra_es="Evitar en obstrucciÃ³n biliar.", contra_en="Avoid in bile duct obstruction."),
   },
