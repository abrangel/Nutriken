...
("omega-3-ethyl-esters","Omega-3 (ésteres etílicos, Rx)","Hipolipemiante","Lipid-lowering",
 ...
 "[DOSIS_CLINICA_REMOVIDA] bajan TG 20–30%; la grasa mejora la absorción.",
 "[DOSIS_CLINICA_REMOVIDA] lower TG 20–30%; fat improves absorption.",
...
("acetaminophen","Paracetamol (acetaminofén)","Analgésico","Analgesic",
 ...
 "Hepatotóxico >[DOSIS_CLINICA_REMOVIDA] o con alcohol. Sumar todas las fuentes.",
 "Hepatotoxic >[DOSIS_CLINICA_REMOVIDA] or with alcohol. Count all sources.","Clínico"),
]
